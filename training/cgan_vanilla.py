...
hparams = {'latent_size': 11, 'output_seq_len': 24, 'condition_size': 11}
...
train_gen = datasets.cgan_generator(train_path, batch_size=1024, shuffle=True)
valid_gen = datasets.cgan_generator(test_path, batch_size=1024, shuffle=True)
